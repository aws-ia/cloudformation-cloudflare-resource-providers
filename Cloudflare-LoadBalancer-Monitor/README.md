...
This resource type manages a [Cloudflare LoadBalancer Monitor][3]
...
1. Write the JSON schema describing your resource, [cloudflare-loadbalancer-monitor.json](./cloudflare-loadbalancer-monitor.json)
2. Implement your resource handlers in [handlers.ts](./cloudflare-loadbalancer-monitor/handlers.ts)

> Don't modify [models.ts](./cloudflare-loadbalancer-monitor/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
...
[3]: https://developers.cloudflare.com/load-balancing/how-to/create-monitor/#via-the-dashboard
[4]: ./docs/README.md
